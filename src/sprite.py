...
WALK_LIST = [pygame.transform.scale(pygame.image.load('./assets/walk/Walk_1.png'),SPRITE_SIZE),pygame.transform.scale(pygame.image.load('./assets/walk/Walk_2.png'),SPRITE_SIZE),pygame.transform.scale(pygame.image.load('./assets/walk/Walk_3.png'),SPRITE_SIZE),pygame.transform.scale(pygame.image.load('./assets/walk/Walk_4.png'),SPRITE_SIZE),pygame.transform.scale(pygame.image.load('./assets/walk/Walk_5.png'),SPRITE_SIZE),pygame.transform.scale(pygame.image.load('./assets/walk/Walk_6.png'),SPRITE_SIZE)]

JUMP_LIST = [pygame.transform.scale(pygame.image.load('./assets/jump/Jump_2.png'),SPRITE_SIZE), pygame.transform.scale(pygame.image.load('./assets/jump/Jump_3.png'),SPRITE_SIZE)]

CRAB_LIST = [pygame.transform.scale(pygame.image.load('./assets/idle/crab.png'),CRAB_SIZE),pygame.transform.scale(pygame.image.load('./assets/idle/crab2.png'),CRAB_SIZE),pygame.transform.scale(pygame.image.load('./assets/idle/crab3.png'),CRAB_SIZE),pygame.transform.scale(pygame.image.load('./assets/idle/crab4.png'),CRAB_SIZE),pygame.transform.scale(pygame.image.load('./assets/idle/crab5.png'),CRAB_SIZE),pygame.transform.scale(pygame.image.load('./assets/idle/crab6.png'),CRAB_SIZE)]

CLOUD = pygame.transform.scale(pygame.image.load('./assets/constants/cloud.png'), CLOUD_SIZE)
